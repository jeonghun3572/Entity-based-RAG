...
class Options:
    ...
    def initialize(self):
        ...
        self.parser.add_argument("--temperature", type=float, default=0.9)
        ...
        self.parser.add_argument("--weight_decay", type=float, default=0.0, help="learning rate")
        ...
        self.parser.add_argument("--wandb_proj", type=str, default=None)
